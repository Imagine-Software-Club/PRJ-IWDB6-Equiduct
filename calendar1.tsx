...
export default function Home() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    let repeatInterval = "";
    if (repeatIntervalElement instanceof HTMLInputElement) {
      repeatInterval = repeatIntervalElement.value;
    }

    const repeaterElement =
      e.currentTarget.elements.namedItem("repeatInterval");
    //const repeater = repeatIntervalElement.value;
    ...
    const numRepeatsElement = e.currentTarget.elements.namedItem("numRepeats");
    const numRepeats = Number((numRepeatsElement as HTMLInputElement)?.value);
    ...
    // Adjust the logic to correctly calculate the end date based on the repeat interval and custom time
    ...
    // Create a new event for each repeat\
    console.log(numRepeats);
    for (let i = 0; i < 10; i++) {
      // Update startDate before creating the event
      if (i == 0) {
        ...
        startDate.setDate(startDate.getDate() + numRepeats);
        const event: Event = {
          ...newEvent,
          start: startDate.toISOString(),
          end: endDate.toISOString(),
                    ...
                    <div>
                      ...
                      <div className="mt-3 text-center sm:mt-5">
                        ...
                        <form action="submit" onSubmit={handleSubmit}>
                          ...
                          <div className="mt-2">
                            <label htmlFor="numRepeats">Repeat Every:</label>
                            <input
                              type="number"
                              id="numRepeats"
                              name="numRepeats"
